 ...
 * Set import files
 */
function profism_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'profism'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'profism_set_import_files' );

/**
 * Define actions that happen after import
 */
function profism_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'profism_actions_after_import' );
