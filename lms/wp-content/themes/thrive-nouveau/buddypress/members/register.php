		...
		<?php bp_nouveau_template_notices(); ?>
			...
			<?php if ( 'request-details' === bp_get_current_signup_step() ) : ?>
				...
				<div class="register-section default-profile" id="basic-details-section">
					...
					<h2 class="bp-heading"><?php _e( 'Account Details', 'thrive-nouveau' ); ?></h2>
				...
				<?php if ( bp_is_active( 'xprofile' ) && bp_nouveau_base_account_has_xprofile() ) : ?>
					...
					<div class="register-section extended-profile" id="profile-details-section">
						...
						<h2 class="bp-heading"><?php _e( 'Profile Details', 'thrive-nouveau' ); ?></h2>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section blog-details" id="blog-details-section">
						...
						<h2><?php _e( 'Blog Details', 'thrive-nouveau' ); ?></h2>

						<p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1" <?php checked( (int) bp_get_signup_with_blog_value(), 1 ); ?>/> <?php _e( "Yes, I'd like to create a new site", 'thrive-nouveau' ); ?></label></p>
