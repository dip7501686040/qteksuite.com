...
<?php else : ?>
    ...
    <div id="document-wrapper-no-sidebar" class="<?php echo apply_filters('thrive-document-wrapper', 'thrive-document-wrapper'); ?>">
                            ...
                            <?php if ( $enable_logo ) { ?>
                                ...
                                <div class="bg-primary" id="thrive-registration-logo">
                                    ...
                                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                                        ...
                                        <?php $default_logo = get_template_directory_uri() . '/logo.svg'; ?>
                                ...
                                <div id="thrive-social-connect"><?php do_action( 'gears_login_form' ); ?></div>
