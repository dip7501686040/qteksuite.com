...
if ( ! class_exists( 'Thrive_Featured_Member_Widget' ) ):
...
class Thrive_Featured_Member_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Thrive: Featured Member', 'thrive-nouveau' ), // Name
			array( 'description' => __( 'Use this widget to feature a member.', 'thrive-nouveau' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( empty ( $user ) ) {
			?>
			<p>
				<?php _e('I can\'t seem to find a user with that username. Please check your username input.', 'thrive-nouveau'); ?>
			</p>
			<?php
		...
		<div class="fmember-member-details">
			...
			<div class="fmember-avatar">
				...
				<a href="<?php echo esc_url( $user_domain ); ?>" alt="<?php _e('Visit Member Profile', 'thrive-nouveau'); ?>">
	...
	public function form( $instance ) {
		...
		$title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Featured Member', 'thrive-nouveau' );
		$username = ! empty( $instance['username'] ) ? $instance['username'] : '';
		?>
		<p>
			
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'thrive-nouveau' ); ?></label>

			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
			
			<span class="help-text">
				<em><?php _e('You can use this field to enter the widget title.', 'thrive-nouveau'); ?></em>
			</span>
		</p>

		<p>
			
			<label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php _e( 'Username:', 'thrive-nouveau' ); ?></label>

			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username  ); ?>">
			
			<span class="help-text">
				<em><?php _e('Enter the username of the member that you want to be featured.', 'thrive-nouveau'); ?></em>
			</span>
