...
switch($_POST['action']) {
	...
	case "editComponents":
		isAuthorized("editComponents"); $status = Components::edit($_POST);
    break;
    ...
    // Consumables
	case "addConsumables":
		isAuthorized("addConsumables"); $status = Consumables::add($_POST);
    break;

	case "editConsumables":
		isAuthorized("editConsumables"); $status = Consumables::edit($_POST);
    break;

	case "deleteConsumables":
		isAuthorized("deleteConsumables"); $status = Consumables::delete($_POST['id']);
    break;


    //addAssets_allocate
    case "addAssetsallocate":
		isAuthorized("addAssetsallocate"); $status = Assetsallocate::add($_POST);
    break;

	case "editAssetsallocate":
		isAuthorized("editAssetsallocate"); $status = Assetsallocate::edit($_POST);
    break;

	case "deleteAssetsallocate":
		isAuthorized("deleteAssetsallocate"); $status = Assetsallocate::delete($_POST['id']);
    break;


    //AssetsReturn
    case "addAssetsreturn":
            isAuthorized("addAssetsreturn"); $status = Assetsreturn::add($_POST);
    break;

	case "editAssetsreturn":
            isAuthorized("editAssetsreturn"); $status = Assetsreturn::edit($_POST);
    break;

	case "deleteAssetsreturn":
            isAuthorized("deleteAssetsreturn"); $status = Assetsreturn::delete($_POST['id']);
    break;


    //Licenses Allocate start
    case "addLicensesallocate":
		isAuthorized("addLicensesallocate"); $status = Licensesallocate::add($_POST);
    break;

	case "editLicensesallocate":
		isAuthorized("editLicensesallocate"); $status = Licensesallocate::edit($_POST);
    break;

	case "deleteLicensesallocate":
		isAuthorized("deleteLicensesallocate"); $status = Licensesallocate::delete($_POST['id']);
    break;

    //Licenses Allocate end
    

    

    //LicenseReturn
    case "addLicensereturn":
            isAuthorized("addLicensereturn"); $status = Licensereturn::add($_POST);
    break;

	case "editLicensereturn":
            isAuthorized("editLicensereturn"); $status = Licensereturn::edit($_POST);
    break;

	case "deleteLicensereturn":
            isAuthorized("deleteLicensereturn"); $status = Licensereturn::delete($_POST['id']);
    break;
	...
	case "addDepartmentCategory":
		isAuthorized("manageMaster"); $status = Department::addDepartmentCategory($_POST);
        break;

	case "editDepartmentCategory":
		isAuthorized("manageMaster"); $status = Department::editDepartmentCategory($_POST);
        break;

	case "deleteDepartmentCategory":
		isAuthorized("manageMaster"); $status = Department::deleteDepartmentCategory($_POST['id']);
        break;
    
	// Master Manager categories
	case "addManagerCategory":
		isAuthorized("manageMaster"); $status = Manager::addManagerCategory($_POST);
        break;

	case "editManagerCategory":
		isAuthorized("manageMaster"); $status = Manager::editManagerCategory($_POST);
        break;

	case "deleteManagerCategory":
		isAuthorized("manageMaster"); $status = Manager::deleteManagerCategory($_POST['id']);
        break;
	
        // Master Approval categories
	case "addApprovalCategory":
		isAuthorized("manageMaster"); $status = Approval::addApprovalCategory($_POST);
        break;

	case "editApprovalCategory":
		isAuthorized("manageMaster"); $status = Approval::editApprovalCategory($_POST);
        break;

	case "deleteApprovalCategory":
		isAuthorized("manageMaster"); $status = Approval::deleteApprovalCategory($_POST['id']);
        break;
