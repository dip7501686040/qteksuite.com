...
if ($route == "pdf") {
	...
	if (!isset($_GET['type'])) die("'type' parameter is missing");
	else $type = $_GET['type'];
...
// CREDENTIALS
if ($route == "inventory/credentials") {
	isAuthorized("viewCredentials");
	$credentials = getTable("credentials");
	$pageTitle = __("Credentials Manager");
}
...
if ($route == "sam/attributes/licensecategories") {
	isAuthorized("manageData");
	$categories = getTable("licensecategories");
	$pageTitle = __("License Categories");
}
...
if ($route == "master/department/departmentcategories") {
	isAuthorized("manageMaster");
	$departmentsCategories = getTable("departmentcategories");
	$pageTitle = __("Department Categories");
}
//Master Department
if ($route == "master/department/departmentcategories") {
...
if ($route == "master/manager/managercategories") {
	...
	$pageTitle = __("Manager Categories");
}
//Master Department
if ($route == "master/manager/managercategories") {
	isAuthorized("viewMaster");
...
if ($route == "master/approval/approvalcategories") {
	...
	$pageTitle = __("Approval Categories");
}
//Master Department
if ($route == "master/approval/approvalcategories") {
	isAuthorized("viewMaster");
