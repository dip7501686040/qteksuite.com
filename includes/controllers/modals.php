...
switch($_GET['modal']) {
    ...
    //Master Department
    case "departmentcategories/edit":
        $category = getRowById("departmentcategories",$_GET['id']);
        break;
    
    //Master Department
    case "managercategories/edit":
        $category = getRowById("managercategories",$_GET['id']);
        break;
    
    //Master Approval
    case "approvalcategories/edit":
        $category = getRowById("approvalcategories",$_GET['id']);
        break;
    ...
    case "assetsallocate/edit":
        $project = getRowById("assetsallocate",$_GET['id']);
        $clients = getTable("clients");
        break;
    

    //ASSETS RETURN
    case "assetsreturn/add":
