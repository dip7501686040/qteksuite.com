...
class Asset extends App
{
    ...
    public static function add($data)
    {
        ...
        if ($lastid == "0") {
            ...
            logSystem("Asset Added - ID: " . $lastid);
            return "10";
        }
    }
            ...
            foreach ($_FILES["file"]["name"] as $key => $value) {
                ...
                if ($uploadOk == 0) {
                    ...
                    if (move_uploaded_file($_FILES["file"]["tmp_name"][$key], $target_file)) {
                        ...
                        $target_file = "/uploads/assets/" . $_FILES["file"]["name"][$key];
                    } else {
                        echo "Sorry, there was an error uploading your file.";
                    }
                }
    ...
    public static function assignLicense($data)
    ...
    public static function unassignLicense($id)
