...
class Licensesallocate extends App {
    ...
    public static function add($data) {
    	...
    	$lastid = $database->insert("licensesallocate", [
    		"userid" => $data['userid'],
    	...
    	if ($lastid == "0") { return "11"; } else { logSystem("Licenses Allocate Added - ID: " . $lastid); return "10"; }
    }
    ...
    public static function edit($data) {
    	...
    	$database->update("licensesallocate", [
                "userid" => $userid,
                "manufacturer" => $manufacturerid,
    		"checkout_date" => dateDb($data['checkout_date']),
    		"checkin_date" => dateDb($data['checkin_date']),
    	...
    	logSystem("Licenses allocate Edited - ID: " . $data['id']);
    	return "20";
    }
    ...
    public static function delete($id) {
    	global $database;
        $database->delete("licensesallocate", [ "id" => $id ]);
    	logSystem("Licenses Allocate Deleted - ID: " . $id);
    	return "30";
    }
